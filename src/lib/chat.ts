...
/**
 * Clear two-tone “sonar” ping — used when you /ping someone or receive a ping.
 * Louder and longer than the soft chat blip so it is hard to miss.
 */
...
/** True when a ping message targets this username (case-insensitive). */
