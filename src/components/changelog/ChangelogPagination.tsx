...
export const ChangelogPagination = memo(function ChangelogPagination({
  page,
  pageCount,
  pageSize,
  total,
  ...
  return (
    <nav
      className="max-w-5xl rounded-lg border border-indigo-500/20 bg-[#1e293b]/50 p-3 font-mono shadow-[0_0_16px_rgba(99,102,241,0.05)]"
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-[9px] text-slate-500">
            Showing {startIdx}–{endIdx} of {total} releases · {pageSize} per page
          </p>
        </div>
